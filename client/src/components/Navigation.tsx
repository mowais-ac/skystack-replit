          ...
          <div className="group relative">
            ...
            <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 w-72">
              <div className="bg-white rounded-md shadow-xl border border-slate-100 p-2 overflow-hidden">
                ...
                <Link
                  href="/business-models/instagram-community-app-development"
                ...
                <div className="h-px bg-slate-100 my-1"></div>
                {businessModels
                  .filter((m) => m.slug !== "instagram-community-app-development")
                  .map((m) => (
                  <Link 
                    key={m.slug} 
          ...
          >
            <div className="p-6 flex flex-col gap-4 text-base font-medium">
              ...
              <div className="space-y-2 border-b border-slate-100 pb-4">
                ...
                <Link href="/business-models/instagram-community-app-development" className="block pl-2 text-primary font-semibold">
                  {language === "ar" ? "تطوير تطبيق شبيه Instagram" : "Instagram App Development"}
                </Link>
              ...
              <Link href="/blog" className="border-b border-slate-100 pb-4">{t("nav.blog")}</Link>
